...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_question_mark_means_optional
    assert_equal 'a', "abbcccddddeeeee"[/a?/]
    assert_equal 'a', "abazbcccddddeeeee"[/az?/]
  end
  ...
  def test_asterisk_means_zero_or_more
    ...
    # ? e * tornam os a letras opcional no macth
  ...
  def test_slash_b_anchors_to_a_word_boundary
    ...
    # \b qualquer coisa que indique o inicio ou fim de uma palavra
    # como espaço em branco ou quebra de linha e (.) indica qualquer
    # caracter valído
  end
